...
// Public papkasini ulash (rasmlar ko'rinishi uchun)
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      ...
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          ...
          <img src="/images/mercurial-superfly-9.png" 
      ...
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          ...
          <img src="/images/adidas-predator-elite.png" 
      ...
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          ...
          <img src="/images/puma-future-ultimate-tf.png" 
      ...
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          ...
          <img src="/images/nike-phantom-gx-ii-elite.png" 
      ...
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          ...
          <img src="/images/nike-tiempo-legend-10.png" 
      ...
      <!-- Card 6: Adidas X Crazyfast -->
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          <span class="jersey-num absolute top-1 right-3 text-5xl font-black select-none opacity-20">06</span>
          <img src="/images/adidas-x-crazyfast.png" 
               alt="Adidas X Crazyfast" 
               class="h-40 w-full object-contain hover:scale-105 transition-transform duration-300">
        </div>
        <div class="p-4 flex flex-col flex-1">
          <span class="text-[11px] uppercase font-bold text-flash mb-1">Maysa uchun (FG)</span>
          <h3 class="font-display font-bold text-lg mb-1 text-white">Adidas X Crazyfast</h3>
      ...
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          ...
          <img src="/images/mizuno-morelia-neo-in.png" 
      ...
      <div class="card-hover bg-surface border border-white/10 rounded-2xl overflow-hidden flex flex-col p-2">
        <div class="relative bg-white rounded-xl h-52 flex items-center justify-center p-3 overflow-hidden">
          ...
          <img src="/images/puma-king-match-fg.png" 
